...
TRANSMITTER_HOST = "192.168.238.15"
TRANSMITTER_PORT = 5000

CONNECT_TIMEOUT = 10.0  # seconds
CAPTURE_SOCKET_TIMEOUT = 60.0  # seconds
...
class ReceiverApp:
    ...
    def request_image(
        ...
        with socket.create_connection(
            (TRANSMITTER_HOST, TRANSMITTER_PORT), timeout=CONNECT_TIMEOUT
        ) as sock:
            # Allow time for the transmitter to wait for a level attitude,
            # capture both cameras, encode images, and send the payload.
            sock.settimeout(CAPTURE_SOCKET_TIMEOUT)
